...
public class SenderDTO implements Serializable {
	private static final long serialVersionUID = -5229093483519418301L;
	@JsonProperty("login")
	...
	public SenderDTO(String login, Long id, String nodeId, String avatarUrl, String gravatarId, String url,
	...
	public String toString() {
		return "SenderDTO [login=" + login + ", id=" + id + ", nodeId=" + nodeId + ", avatarUrl=" + avatarUrl
