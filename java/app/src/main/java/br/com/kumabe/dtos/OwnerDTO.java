...
public class OwnerDTO implements Serializable {
	private static final long serialVersionUID = -4584886689021314075L;
	@JsonProperty("login")
	...
	public OwnerDTO(String login, Long id, String nodeId, String avatarUrl, String gravatarId, String url,
	...
	public String toString() {
		return "OwnerDTO [login=" + login + ", id=" + id + ", nodeId=" + nodeId + ", avatarUrl=" + avatarUrl
