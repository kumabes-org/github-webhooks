...
public class UserDTO implements Serializable {
	private static final long serialVersionUID = 2760842813119566791L;
	@JsonProperty("login")
	...
	public UserDTO(String login, Long id, String nodeId, String avatarUrl, String gravatarId, String url,
